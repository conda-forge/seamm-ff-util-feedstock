...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/seamm-ff-util-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12740&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/seamm-ff-util-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `seamm-ff-util` can be installed with:

```
conda install seamm-ff-util
```

It is possible to list all of the versions of `seamm-ff-util` available on your platform with:
